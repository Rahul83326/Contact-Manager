...
const Dashboard = () => {
  ...
  return (
    <div className="  w-full pt-20 px-4 pb-8" >
      <h1 className="text-3xl font-bold mb-4 text-pink-500">Covid-19 Chart</h1>
      ...
      <h1 className="text-3xl font-bold mb-4 mt-4 text-blue-400">Covid-19 World Map</h1>
      <div
        className="border-2 border-blue-300 w-11/12  m-auto 5 auto 5"

      >
        <MapContainer

          className="m-auto w-full  border-blue-300"
