...
const Contacts = () => {
    ...
    return (
        <div className="justify-center pt-16 text-gray-50   p-4  w-full ">
            <div className="m-4">
                <button className="rounded-full font-bold hover:bg-sky-500 bg-sky-400 p-4 text-2xl">
            ...
            {AllContacts.length == 0 && <div className=" m-auto w-fit p-4 align-middle text-blue-500 justify-center">
                ...
                <h1 className="text-2xl">No Contact Added </h1>
            </div>}
            <div id="contact_list" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">

                {
                    AllContacts.map((el) => {
                        return <div key={el.id} className=" bg-sky-700 rounded-xl shadow-xl m-4 p-4 text-white">
                            <div onClick={() => togglePopup(el)} className="w-3/4 m-auto  ">
                                ...
                                <div className="p-4">
                                  ...
                                  <div className="text-left p-1 rounded-md bg-teal-50 text-black">
                            ...
                            <div className="flex justify-between table-fixed my-2">
                                <Link to={`edit/${el.id}`}>
                                    <button className="rounded p-2 bg-cyan-300 hover:bg-sky-400 text-black">

                                        Edit
                                    </button>
                                </Link>

                                <button onClick={() => dispatch(removeContact(el.id))} className="rounded p-2 bg-red-500 hover:bg-red-600 text-white">Delete</button>
                            </div>
                        </div>
                    })
                }
